...
const HomeScreen = () => {
  ...
  return (
    <View
      ...
      <ScrollView style={
        isBlackTheme ? styles.containerBlack : styles.container
      }>
        {/* Hero Section */}
        <View style={styles.hero}>
          ...
          <Text style={styles.heroDescription}>
            Make your favorite apps connect with each other and let us automatize
            tasks for you!
          </Text>
          <TouchableOpacity 
            style={styles.button}
        ...
        <View style={styles.section}>
          ...
          }>Make your day easy</Text>
          <Text style={styles.sectionSubtitle}>
            Discover new ways to create useful workflows
          </Text>
          {workflows.map((workflow) => (
            <View key={workflow.id} style={
              isBlackTheme ? styles.cardBlack : styles.card
            }>
              <Text style={
                isBlackTheme ? styles.cardTitleBlack : styles.cardTitle
              }>{workflow.title}</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.link}>
            You can see the documentation on our github repository to learn more about us!
          </Text>
        </View>
      </ScrollView>
    </View>
