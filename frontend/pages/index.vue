    ...
    <div class="flex flex-col bg-secondaryWhite-500 dark:bg-primaryDark-500">
          ...
          <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            >
              <div class="grid md:grid-rows-3 gap-8">
                ...
                >
                  <div class="mx-6">
                    <h3 class="text-md mb-4 text-fontBlack dark:text-fontWhite">
      ...
      >
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 mb-4 dark:text-fontWhite">
            Make your day easy
          </h2>
          ...
          >
            ...
            <div class="flex items-center space-x-4 mb-4">
              <div class="flex items-center">
                ...
                />
                <span class="ml-4 text-fontBlack dark:text-fontWhite">{{
            ...
            <p class="text-gray-600 dark:text-fontWhite">
